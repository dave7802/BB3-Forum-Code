...
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?)clipfish.de\/video\/(.*?)">(.*?)<\/a>#U', 
...
// remote link
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?).(mp3|MP3)">(.*?)<\/a>#U', '<object type="application/x-shockwave-flash" data="mediaplayer/mp3_player.swf" width="200" height="55"><param name="movie" value="mediaplayer/mp3_player.swf" /><param name="flashvars" value="src=http://$1.mp3" /></object>', $message);
// local link
...
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?)myvideo.de\/watch\/(.*?)">(.*?)<\/a>#U', '<object type="application/x-shockwave-flash" style="width:425px; height:350px" data="http://www.myvideo.de/movie/$2"><param name="movie" value="http://www.myvideo.de/movie/$2" /><param name="allowfullscreen" value="true" /></object>', $message);}

// veoh
if (($veoh) && (strpos($message, 'veoh.com/') !== false)){
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?)veoh.com\/(.*?)\/watch\/(.*?)">(.*?)<\/a>#U', 
...
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?)youtube(.*?)\/watch\?v=(.*?)">(.*?)<\/a>#U', '<object type="application/x-shockwave-flash" style="width:425px; height:344px" data="http://$1youtube$2/v/$3"><param name="movie" value="http://$1youtube$2/v/$3&amp;hl=de&amp;fs=1&amp;rel=0&amp;hd=1" /><param name="allowfullscreen" value="true" /></object>', $message);}

// youtube_lnk
if (($youtube_lnk) && (strpos($message, '/watch?v=') !== false)){
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?)youtube(.*?)\/watch\?v=([A-Za-z0-9]+)(.*?)">(.*?)<\/a>#is', '<a href="http://$1youtube$2/v/$3$4&amp;hl=en&amp;fs=1&amp;rel=0&amp;hd=1">http://$1youtube$2/watch?v=$3$4&amp;hl=en&amp;fs=1&amp;rel=0&amp;hd=1</a>&nbsp;&nbsp;&nbsp;<span style="cursor:pointer;" onclick="spoile(&apos;yt_'.$row['post_id'].'$3&apos;);"><img src="images/embed.gif" alt="" /></span><div id="yt_'.$row['post_id'].'$3" style="display:none;"><br /><object type="application/x-shockwave-flash" style="width:425px; height:344px" data="http://$1youtube$2/v/$3$4&amp;hl=en&amp;fs=1&amp;rel=0&amp;hd=1"><param name="movie" value="http://$1youtube$2/v/$3$4&amp;hl=en&amp;fs=1&amp;rel=0&amp;hd=1" /><param name="allowfullscreen" value="true" /></object></div>', $message);}

// youtube_new
if (($youtube_new) && (strpos($message, 'youtu.be/') !== false)){
$message = preg_replace('#<a class="postlink" href="http:\/\/(.*?)youtu.be\/(.*?)">(.*?)<\/a>#U', '<object type="application/x-shockwave-flash" style="width:425px; height:344px" data="http://youtube.com/v/$2&amp;hl=en&amp;fs=1&amp;rel=0&amp;hd=1"><param name="movie" value="http://youtube.com/v/$2&amp;hl=en&amp;fs=1&amp;rel=0&amp;hd=1" /><param name="allowfullscreen" value="true" /></object>', $message);}
