...
class acp_board
{
			...
			case 'security':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						/* check_dnsbl replaced with check_iprbl_... and both settings moved to BLOCK SETTINGS by Advanced Block MOD
	...
	*/
	...
	{
		$radio_ary = array(CHECK_NONE => 'NO_CHECK', CHECK_GUESTS => 'GUESTS_ONLY', CHECK_ALL => 'ALL');
