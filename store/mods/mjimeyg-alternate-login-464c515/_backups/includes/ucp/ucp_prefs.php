			...
			case 'personal':
				...
				$data = array(
					...
					'allowpm'		=> request_var('allowpm', (bool) $user->data['user_allow_pm']),
                                    'hide_al_fb_activity'   => request_var('al_fb_activity', $user->data['al_fb_hide_activity']),
                                        ...
                                        'hide_al_fb_like_box'   => request_var('al_fb_like_box', $user->data['al_fb_hide_like_box']),
				);
				...
				if ($submit)
				{
					...
					if (!sizeof($error))
					{
						...
						$sql_ary = array(
                            ...
                            'al_fb_hide_like_box'           => $data['hide_al_fb_like_box'],
						);
