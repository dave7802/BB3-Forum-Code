...
$template->assign_vars(array(
	...
	'REPORT_SPAM_IMG' 	=> $user->img('icon_post_report_spam', 'REPORT_SPAM_POST'),
...
for ($i = 0, $end = sizeof($post_list); $i < $end; ++$i)
{
	...
	$postrow = array(
		...
		'U_REPORT_SPAM'		=> ($delete_allowed) ? append_sid("{$phpbb_root_path}posting.$phpEx", "mode=report_spam&amp;f=$forum_id&amp;p={$row['post_id']}") : '',
