...
function mcp_post_details($id, $mode, $action)
{
	...
	$template->assign_vars(array(
		...
		'POST_USER_EMAIL'		=> $post_info['post_user_email'],
		...
		'U_RECHECK_SPAM'		=> ($auth->acl_get('m_info', $post_info['forum_id'])) ? append_sid("{$phpbb_root_path}mcp.$phpEx", "i=$id&amp;mode=$mode&amp;action=recheck_spam&amp;p=$post_id") : '',
	));
