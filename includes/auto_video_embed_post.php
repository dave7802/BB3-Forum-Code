...
// Debuging tool
//$preview_message = $preview_message . htmlentities( $preview_message );


// clipfish
if (($clipfish) && (strpos($preview_message, 'clipfish.de') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)clipfish\.de\/video\/([^>"]*)"[^>]*>([^>]*)<\/a>#is', '<object width="' . $clipfish_width . '" height="' . $clipfish_height . '" type="application/x-shockwave-flash" data="http://www.clipfish.de/cfng/flash/clipfish_player_3.swf" style="visibility: visible;"><param name="quality" value="high" /><param name="wmode" value="opaque" /><param name="allowscriptaccess" value="always" /><param name="allowfullscreen" value="true" /><param name="flashvars" value="data=http://www.clipfish.de/devxml/videoinfo/$2&amp;ec=http://www.clipfish.de/embed/video/$2&amp;vid=$2" /></object>', $preview_message);
}
...
if (($metacafe) && (strpos($preview_message, 'metacafe.com/watch/') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)metacafe\.com\/watch\/([^>"]*)\/([^>"]*)"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" style="height:345px;width:400px;" data="http://www.metacafe.com/fplayer/$2/$3.swf"><param name="movie" value="http://www.metacafe.com/fplayer/$2/$3.swf" /><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /></object>', $preview_message);
}

// mixcloud
if (($mixcloud) && (strpos($preview_message, 'mixcloud.com/') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)mixcloud\.com\/([^>"]*)"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" data="http://www.mixcloud.com/media/swf/player/mixcloudLoader.swf?v=20" width="300" height="300"><param name="movie" value="http://www.mixcloud.com/media/swf/player/mixcloudLoader.swf?v=20" /><param name="flashvars" value="feed=http://www.mixcloud.com/$2" /><param name="allowscriptaccess" value="always" /><param name="allowfullscreen" value="true" /><param name="quality" value="high" /></object>', $preview_message);
}

// mp3
if (($mp3) && ((strpos($preview_message, '.mp3">') !== false) or (strpos($preview_message, '.MP3">') !== false))) {
    // remote link
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)\.mp3"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" data="mediaplayer/mp3_player.swf" width="200" height="55"><param name="movie" value="mediaplayer/mp3_player.swf" /><param name="flashvars" value="src=http://$1.mp3" /></object>', $preview_message);
    // local link
    $preview_message = preg_replace('#<a class="postlink-local" href="https?:\/\/([^>"]*)\.mp3"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" data="mediaplayer/mp3_player.swf" width="200" height="55"><param name="movie" value="mediaplayer/mp3_player.swf" /><param name="flashvars" value="src=http://$1.mp3" /></object>', $preview_message);
}

// myspace
if (($myspace) && (strpos($preview_message, 'vids.myspace.com/index.cfm') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/vids\.myspace\.com\/index\.cfm\?fuseaction=vids\.individual&amp;videoid=([^>"]*)"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" style="width:425px; height:360px;" data="http://mediaservices.myspace.com/services/media/embed.aspx/m=$1,t=1,mt=video"><param name="movie" value="http://mediaservices.myspace.com/services/media/embed.aspx/m=$1,t=1,mt=video" /><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /></object>', $preview_message);
}

// myvideo
if (($myvideo) && (strpos($preview_message, 'myvideo.de/watch/') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)myvideo\.de\/watch\/([^>"]*)"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" style="width:425px; height:350px" data="http://www.myvideo.de/movie/$2"><param name="movie" value="http://www.myvideo.de/movie/$2" /><param name="allowfullscreen" value="true" /></object>', $preview_message);
}

// veoh
if (($veoh) && (strpos($preview_message, 'veoh.com/') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)veoh.com\/([^>"]*)\/watch\/([^>"]*)"[^>]*>([^>]*)<\/a>#is', 
...
if (($vimeo) && (strpos($preview_message, 'vimeo.com/') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)vimeo\.com\/([^>"]*)"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" style="width:400px;height:230px;" data="http://vimeo.com/moogaloop.swf?clip_id=$2&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=&amp;fullscreen=1"><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=$2&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=&amp;fullscreen=1" /></object>', $preview_message);
}

// yahoo
// reminder: checking yahoo fullscreen mode availability
if (($yahoo) && (strpos($preview_message, 'video.yahoo.com/') !== false)) {
    $preview_message = preg_replace('#<a class="postlink" href="https?:\/\/([^>"]*)video\.yahoo\.com\/([^>"]*)\/([^>"]*)\/([^>"]*)-([^>"]*).html"[^>]*>([^>]*)<\/a>#is', '<object type="application/x-shockwave-flash" data="http://d.yimg.com/nl/vyc/site/player.swf" width="630" height="354"><param name="movie" value="http://d.yimg.com/nl/vyc/site/player.swf" /><param name="flashvars" value="vid=$5&amp;autoPlay=false&amp;volume=100&amp;enableFullScreen=1&amp;lang=$1" /><param name="quality" value="high" /></object>', $preview_message);
}
